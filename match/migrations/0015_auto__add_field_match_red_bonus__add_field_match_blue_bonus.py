...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.red_bonus'
        db.add_column('match_match', 'red_bonus', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Match.blue_bonus'
        db.add_column('match_match', 'blue_bonus', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.red_bonus'
        db.delete_column('match_match', 'red_bonus')

        # Deleting field 'Match.blue_bonus'
        db.delete_column('match_match', 'blue_bonus')
