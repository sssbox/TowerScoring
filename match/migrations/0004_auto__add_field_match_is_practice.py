...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.is_practice'
        db.add_column('match_match', 'is_practice', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.is_practice'
        db.delete_column('match_match', 'is_practice')
