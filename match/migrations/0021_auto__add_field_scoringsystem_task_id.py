...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScoringSystem.task_id'
        db.add_column('match_scoringsystem', 'task_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScoringSystem.task_id'
        db.delete_column('match_scoringsystem', 'task_id')
