...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('match_scoringdevice', 'tower_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['match.Tower'], unique=True, null=True))

        # Adding unique constraint on 'ScoringDevice', fields ['tower']
        db.create_unique('match_scoringdevice', ['tower_id'])

        # Changing field 'ScoringDevice.scorer'
        db.alter_column('match_scoringdevice', 'scorer_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'ScoringDevice', fields ['scorer']
        db.create_unique('match_scoringdevice', ['scorer_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScoringDevice', fields ['scorer']
        db.delete_unique('match_scoringdevice', ['scorer_id'])

        # Removing unique constraint on 'ScoringDevice', fields ['tower']
        db.delete_unique('match_scoringdevice', ['tower_id'])
        ...
        # Changing field 'ScoringDevice.scorer'
        db.alter_column('match_scoringdevice', 'scorer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
