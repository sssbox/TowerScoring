...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScoringDevice.last_contact'
        db.add_column('match_scoringdevice', 'last_contact', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScoringDevice.last_contact'
        db.delete_column('match_scoringdevice', 'last_contact')
    ...
    models = {
        ...
        'match.scoringdevice': {
            ...
            'scorer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'tower': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['match.Tower']", 'null': 'True', 'blank': 'True'})
        },
        'match.scoringsystem': {
