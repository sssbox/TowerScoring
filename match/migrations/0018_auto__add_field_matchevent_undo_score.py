...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MatchEvent.undo_score'
        db.add_column('match_matchevent', 'undo_score', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MatchEvent.undo_score'
        db.delete_column('match_matchevent', 'undo_score')
