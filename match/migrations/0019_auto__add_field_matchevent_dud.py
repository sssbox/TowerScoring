...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MatchEvent.dud'
        db.add_column('match_matchevent', 'dud', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MatchEvent.dud'
        db.delete_column('match_matchevent', 'dud')
