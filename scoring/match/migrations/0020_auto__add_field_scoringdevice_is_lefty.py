...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScoringDevice.is_lefty'
        db.add_column('match_scoringdevice', 'is_lefty', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScoringDevice.is_lefty'
        db.delete_column('match_scoringdevice', 'is_lefty')
