...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.blue_center_active_start'
        db.add_column('match_match', 'blue_center_active_start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Match.red_center_active_start'
        db.add_column('match_match', 'red_center_active_start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.blue_center_active_start'
        db.delete_column('match_match', 'blue_center_active_start')

        # Deleting field 'Match.red_center_active_start'
        db.delete_column('match_match', 'red_center_active_start')
