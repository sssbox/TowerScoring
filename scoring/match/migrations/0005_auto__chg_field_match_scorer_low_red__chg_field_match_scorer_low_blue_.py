...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Match.scorer_low_red'
        db.alter_column('match_match', 'scorer_low_red_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Match.scorer_low_blue'
        db.alter_column('match_match', 'scorer_low_blue_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Match.actual_start'
        db.alter_column('match_match', 'actual_start', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Match.scorer_high_blue'
        db.alter_column('match_match', 'scorer_high_blue_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Match.scorer_high_red'
        db.alter_column('match_match', 'scorer_high_red_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
