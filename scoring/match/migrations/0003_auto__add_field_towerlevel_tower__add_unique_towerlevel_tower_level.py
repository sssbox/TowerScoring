...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TowerLevel.tower'
        db.add_column('match_towerlevel', 'tower', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['match.Tower']), keep_default=False)

        # Adding unique constraint on 'TowerLevel', fields ['tower', 'level']
        db.create_unique('match_towerlevel', ['tower_id', 'level'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TowerLevel', fields ['tower', 'level']
        db.delete_unique('match_towerlevel', ['tower_id', 'level'])

        # Deleting field 'TowerLevel.tower'
        db.delete_column('match_towerlevel', 'tower_id')
