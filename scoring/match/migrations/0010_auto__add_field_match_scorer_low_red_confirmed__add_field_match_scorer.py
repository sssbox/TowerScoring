...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.scorer_low_red_confirmed'
        db.add_column('match_match', 'scorer_low_red_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Match.scorer_high_red_confirmed'
        db.add_column('match_match', 'scorer_high_red_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Match.scorer_low_blue_confirmed'
        db.add_column('match_match', 'scorer_low_blue_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Match.scorer_high_blue_confirmed'
        db.add_column('match_match', 'scorer_high_blue_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.scorer_low_red_confirmed'
        db.delete_column('match_match', 'scorer_low_red_confirmed')

        # Deleting field 'Match.scorer_high_red_confirmed'
        db.delete_column('match_match', 'scorer_high_red_confirmed')

        # Deleting field 'Match.scorer_low_blue_confirmed'
        db.delete_column('match_match', 'scorer_low_blue_confirmed')

        # Deleting field 'Match.scorer_high_blue_confirmed'
        db.delete_column('match_match', 'scorer_high_blue_confirmed')
